...
function Main({universities}) {
  ...
  useEffect(() => {
    if (cityFromLocalStorage) {
      ...
      return setCity(univers.find(f => f.id === id));
    }
  }, [id]);
  return (
    <main>
            ...
            <div className="banner__content">
              <div className="banner__info">
                <div className="banner__info-title boldTxt">
                  <h2>Московский государственный технический университет имени Н.Э. Бáумана</h2>
                </div>
                <ul className="banner__list mediumTxtOS">
                  <li className="reviews">
                    <b>2.4</b>(75 отзывов)
                  </li>
                  <li>Москва, ул. Новочеремушкинская, д. 69</li>
